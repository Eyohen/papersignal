                  ...
                  <div className="mb-5">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className={`w-full pl-10 px-4 py-2 border ${errors.fullName ? 'border-red-300' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent`}
